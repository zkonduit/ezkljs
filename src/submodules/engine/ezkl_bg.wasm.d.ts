/* tslint:disable */
/* eslint-disable */
export function poseidon_hash_wasm(a: number, b: number, c: number): void;
export function elgamal_encrypt_wasm(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function elgamal_decrypt_wasm(a: number, b: number, c: number, d: number, e: number): void;
