...
* @returns {Uint8Array}
*/
export function genPk(circuit_ser: Uint8ClampedArray, params_ser: Uint8ClampedArray, circuit_settings_ser: Uint8ClampedArray): Uint8Array;
/**
...
* @returns {Uint8Array}
*/
export function genVk(pk: Uint8ClampedArray, circuit_settings_ser: Uint8ClampedArray): Uint8Array;
/**
...
export interface InitOutput {
  ...
  readonly genPk: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly genVk: (a: number, b: number, c: number, d: number, e: number) => void;
