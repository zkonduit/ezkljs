...
export function poseidonHash(message) {
    try {
        ...
        wasm.poseidon_hash_wasm(retptr, ptr0, len0);
...
export function elgamalEncrypt(pk, message, r) {
    try {
        ...
        wasm.elgamal_encrypt_wasm(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export function elgamalDecrypt(cipher, sk) {
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.elgamal_decrypt_wasm(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
* @returns {Uint8Array}
*/
export function genPk(circuit_ser, params_ser, circuit_settings_ser) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
export function genVk(pk, circuit_settings_ser) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(pk, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
function init_memory(imports, maybe_memory) {
    imports.wbg.memory = maybe_memory || new WebAssembly.Memory({initial:26,maximum:16384,shared:true});
}
...
function initSync(module, maybe_memory) {
    ...
    init_memory(imports, maybe_memory);
